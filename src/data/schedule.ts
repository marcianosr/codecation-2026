...
export const SCHEDULE: Day[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { start: '15:30', end: '17:30', activity: 'Opfrissen en naar restaurant', links: [{ label: 'Kaart', icon: 'map', url: 'https://www.google.com/maps/dir/Dorperheideweg+12,5944+NK+Arcen/Kruisweg+43,5944+EM+Arcen' }, { label: 'Menu', icon: 'menu', url: 'https://www.hertogjanproeverij.nl/menukaart/#hoofdgerechten' }] },
      { start: '18:00', end: null, activity: 'Restaurant — Hertog Jan Proeverij', links: [{ label: 'Kaart', icon: 'map', url: 'https://www.google.com/maps/search/?api=1&query=Kruisweg+43,5944+EM+Arcen' }, { label: 'Menu', icon: 'menu', url: 'https://www.hertogjanproeverij.nl/menukaart/#hoofdgerechten' }] },
